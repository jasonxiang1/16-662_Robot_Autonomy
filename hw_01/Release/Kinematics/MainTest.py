...
joint_targets = [[0., 0., 0., 0., 0.], \
                 [-45.*deg_to_rad,-15.*deg_to_rad,20.*deg_to_rad,15.*deg_to_rad,-75.*deg_to_rad], \
                 [30.*deg_to_rad,60.*deg_to_rad,-65.*deg_to_rad,45.*deg_to_rad,0.*deg_to_rad],\
		 ]
...
qInit=[0.0,-0.5,1.0,0.5,0.0] # initial joint positions
HGoal= np.array([[0.,0.,1.,0.367], # target EE pose
		 [0.,1.,0.,0.0],
		 [-1.,0,0.,0.111],
		 [0.,0.,0.,1]])
